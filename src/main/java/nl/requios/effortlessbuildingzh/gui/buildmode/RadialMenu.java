...
import nl.requios.effortlessbuildingzh.ModClientEventHandler;
...
import static nl.requios.effortlessbuildingzh.buildmode.BuildModes.*;
...
public class RadialMenu extends Screen {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int mouseButton) {
        EffortlessBuildingZh.log("mouse clicked");
