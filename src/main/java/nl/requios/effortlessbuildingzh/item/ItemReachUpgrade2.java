...
public class ItemReachUpgrade2 extends Item {
    ...
    public ItemReachUpgrade2() {
        ...
        this.setRegistryName(EffortlessBuildingZh.MODID, "reach_upgrade2");
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity player, Hand hand) {
        ...
        if (currentLevel == 1) {
            ...
            if (world.isRemote) EffortlessBuildingZh.log(player, "请先升到1级");
    ...
    public void addInformation(ItemStack stack, @Nullable World world, List<ITextComponent> tooltip, ITooltipFlag flag) {
        tooltip.add(new StringTextComponent(TextFormatting.GRAY + "可将手长提升至" + TextFormatting.BLUE + BuildConfig.reach.maxReachLevel2.get() + TextFormatting.GRAY + "方块"));
        tooltip.add(new StringTextComponent(TextFormatting.GRAY + "需要先升到1级"));
    }
